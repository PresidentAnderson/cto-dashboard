-- CTO Dashboard - Minimal Working Setup
-- Creates tables, then admin user - no views/triggers that might cause errors
...
-- TABLE: projects (must be before bugs due to foreign key)
